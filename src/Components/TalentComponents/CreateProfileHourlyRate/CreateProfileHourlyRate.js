    ...
    return (
        <section className=" bg-white border rounded mt-3 pt-4">
                ...
                <div>
                    <div className="mb-3 d-flex justify-content-between">
                        ...
                        <div className="me-5 mt-2 position-relative jd-inp-cn">
                            <div className="position-absolute"><i className="fas fa-dollar-sign"></i></div>
                            <input className="form-control text-end" type="text" value="00.00" /><span className="position-absolute">/hr</span>
                        </div>
                    </div>
                    <div className="mb-3 d-flex justify-content-between border-top pt-3">
                        <div>
                            <span><strong>Upwork Service Fee</strong><a className="upw-c-cn fw-normal ms-3" href="">Explain this</a></span>
                            <p className="w-75">The Upwork Service Fee is 20% when you begin a contract with a new client. Once you bill over $500 with your client, the fee will be 10%.</p>
                        </div>
                        <div className="me-5 mt-4 d-flex">
                            <span style={{ position: "relative", right: "148px" }}><i className="fas fa-dollar-sign"></i></span>
            ...
            <div className="px-4 my-3 pt-4 border-top d-flex justify-content-between">
                ...
                <Link className="btn bg-upwork px-5" to="/create-profile/title-and-overview">Next</Link>
            </div>
        </section>
    )
}
