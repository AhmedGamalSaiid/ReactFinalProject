    ...
    return (
        <section className="bg-white border rounded mt-3 pt-4">
            ...
            <div className="px-4 my-4">
                ...
                <p>We take your privacy very seriously. Only your city and country will be shown to clients.</p>
            ...
            <div className="px-4 my-3 pt-4 border-top d-flex justify-content-between">
                ...
                <Link className="btn bg-upwork px-5" to="/create-profile/phone-number">Next</Link>
            </div>
        </section >
    )
}
