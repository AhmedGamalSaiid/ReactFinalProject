    ...
    return (
        <section className=" bg-white border rounded mt-3 pt-4">
            ...
            <div className="ps-4 my-5">
                <p className="fw-bold mt-5">What is your level of experience in this field?</p>
                <div className="my-4 mx-4 d-flex justify-content-between">
                    <label className="border border-success rounded p-3 text-center w-25">
                        <input type="radio" className="float-end" name="expertise-level" value="Entry-level" />
                        <h5 className="my-4">Entry level</h5>
                        <div>I am relatively new to this field</div>
                    </label>
                    <label className="border border-success rounded p-3 text-center w-25">
                        <input type="radio" className="float-end" name="expertise-level" value="Intermediate" />
                        <h5 className="my-4">Intermediate</h5>
                        <div>I have substantial experience in this field</div>
                    </label>
                    <label className="border border-success rounded p-3 text-center w-25">
                        <input type="radio" className="float-end" name="expertise-level" value="Expert" />
            ...
            <div className="px-4 my-3 pt-4 border-top d-flex justify-content-between">
                ...
                <Link className="btn bg-upwork px-5" to="/create-profile/education-and-employment">Next</Link>
            </div>
        </section>
    )
}
